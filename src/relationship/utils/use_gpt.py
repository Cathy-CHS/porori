...
# 알파벳 순으로 정렬
sorted_relationships = dict(sorted(dictionary.items(), key=lambda item: item[0]))


import json

with open("gpt_relationships.json", "w") as f:
    json.dump(sorted_relationships, f, ensure_ascii=False, indent=4)
