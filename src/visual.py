...
# 한국어 폰트 설정
font_path = 'C:/Windows/Fonts/gulim.ttc'  # 한국어 폰트 파일 경로
fontprop = fm.FontProperties(fname=font_path)
plt.rc('font', family=fontprop.get_name())

# data = [
#     (Entity('Person', '태조', 0, 2), Entity('Place', '수창궁', 3, 6), '거주'),
#     (Entity('Person', '공양왕', 7, 10), Entity('Person', '태조', 11, 13), '동생')
# ]

csv_file = 'relations_output.csv'
...
nx.draw(G, pos, with_labels=True, node_size=3000, node_color='lightblue', font_size=10, font_weight='bold', arrows=False, edge_color='gray', width=2, font_family=fontprop.get_name())
# nx.draw 인자 설명
...
nx.draw_networkx_edge_labels(G, pos, edge_labels=edge_labels, font_color='red', font_family=fontprop.get_name())
